        ...
        try:
            ...
            if success:
                ...
                self.db_manager.log_newsletter_send(
                    len(new_posts), True, None, self.config.get_recipients(), editor_words, self.config.get_newsletter_title()
                )
                ...
                self.db_manager.log_newsletter_send(
                    ...
                    False,
                    "发送失败",
                    self.config.get_recipients(),
                    editor_words,
                    self.config.get_newsletter_title(),
                )
